<a href="{{ route('user.show', ['user' => $notification->data['inviter_id']]) }}">
  <div class="flex items-center gap-x-2">
    ...
    <p class="mb-4 dark:text-gray-50">{{ $notification->data['inviter_name'] }}さんから「{{ $notification->data['community_name'] }}」へ招待されました。</p>
  </div>
</a>
